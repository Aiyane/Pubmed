...
with open("D:/我的文档/Documents/GitHub/Pubmed/前端2/template/model.html", "r", encoding="utf8") as fi:
    html = fi.read()
...
with open("D:/我的文档/Documents/GitHub/Pubmed/index.html", "w", encoding="utf8") as fou:
    fou.write(res)
